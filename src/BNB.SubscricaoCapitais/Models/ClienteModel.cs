...
public class ClienteModel
{
    ...
    public ClienteModel(ControllerBase ctrl, ClienteEntity entity)
    {
        ...
        Links["self"] = ctrl.Link<ClientesController>(
           nameof(ClientesController.Get), routeValues: new { idInvestidor = entity.IdInvestidor }
        );

        Links["post"] = ctrl.Link<ClientesController>(
           nameof(ClientesController.Post), routeValues: new { }
        );
    }
